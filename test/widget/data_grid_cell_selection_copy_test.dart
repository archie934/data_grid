...
void main() {
  ...
  group('Cell selection and copy', () {
    ...
    test(
      'ShiftSelectCellEvent on empty path acts like FocusCellEvent',
      () async {
        controller.addEvent(ShiftSelectCellEvent(rowId: 2, columnId: 1));
        await Future.delayed(Duration.zero);
    ...
    test('ToggleCellInSelectionEvent adds a cell when absent', () async {
      controller.addEvent(FocusCellEvent(rowId: 1, columnId: 1));
      await Future.delayed(Duration.zero);
      controller.addEvent(ToggleCellInSelectionEvent(rowId: 2, columnId: 1));
      await Future.delayed(Duration.zero);
    ...
    test('ToggleCellInSelectionEvent removes a cell when present', () async {
      ...
      controller.addEvent(ToggleCellInSelectionEvent(rowId: 2, columnId: 1));
      await Future.delayed(Duration.zero);
      controller.addEvent(ToggleCellInSelectionEvent(rowId: 1, columnId: 1));
      await Future.delayed(Duration.zero);
    ...
    test(
      'NavigateCellEvent with extend=true shrinks path when going back',
      () async {
        controller.addEvent(FocusCellEvent(rowId: 1, columnId: 1));
        await Future.delayed(Duration.zero);
        controller.addEvent(
    ...
    testWidgets(
      'CopyCellsEvent copies single numeric cell value to clipboard',
      (tester) async {
        final clipboardData = <String, dynamic>{};
        tester.binding.defaultBinaryMessenger.setMockMethodCallHandler(
          SystemChannels.platform,
    ...
    testWidgets('CopyCellsEvent copies a row of two cells as comma-separated', (
      ...
      controller.addEvent(FocusCellEvent(rowId: 1, columnId: 1));
      await tester.pumpAndSettle();
      controller.addEvent(ToggleCellInSelectionEvent(rowId: 1, columnId: 2));
      await tester.pumpAndSettle();
    ...
    testWidgets('Enter on focused editable cell starts editing', (
      tester,
    ) async {
